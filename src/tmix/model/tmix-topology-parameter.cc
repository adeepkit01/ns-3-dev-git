...
TmixToplogyParameters::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::TmixToplogyParameters")
    ...
    .AddAttribute ("routerDeviceInRate",
                   "Delay in periphary nodes to router channel",
                   DataRateValue (DataRate ("1000Mbps")),
...
TmixToplogyParameters::TmixToplogyParameters (void)
{
  ...
  m_tmixDeviceRate = DataRate ("1000Mbps");
  m_routerDeviceInRate = DataRate ("1000Mbps");
  m_routerDeviceOutRate = DataRate ("1000Mbps");
